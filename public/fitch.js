...
const input_test = document.getElementById("input_test"); // получаем поле
const block_check = document.getElementById("block_check"); // получаем блок с индикатором

input_test.addEventListener("keyup", (evt) => {
